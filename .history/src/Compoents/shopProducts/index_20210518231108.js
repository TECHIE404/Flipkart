...
import ProductCard from '../../Compoents/shopProducts/Image_Card'
import './index.css';
...
function SecondSectionShop(props){
    ...
    <div className="col-9 shop-part-two">
                        <div className="first-ul" style={{listStyleType:"none"}}>
                            ...
                            <li style={{listStyleType:"none"}}>Home <svg width="10" height="10" viewBox="0 0 16 27" xmlns="http://www.w3.org/2000/svg" className="_3OIXYB"><path d="M16 23.207L6.11 13.161 16 3.093 12.955 0 0 13.161l12.955 13.161z" fill="#000000" className="zTtNVt"></path></svg></li>
