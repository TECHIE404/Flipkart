    ...
    return(
        <div>
            <div className="home_footer">
                <div>
                    <h3 className="title" style={{textAlign:'left'}}>Flipkart: The One-stop Shopping Destination</h3>
                ...
                <div>
                    <h3 style={{textAlign:'left'}}>Flipkart Plus</h3>
                ...
                <div>
                    <h3 style={{textAlign:'left'}}>No Cost EMI</h3>
                ...
                <div>
                    <h3 style={{textAlign:'left'}}>EMI on Debit Cards</h3>
                ...
                <div>
                    <h3 style={{textAlign:'left'}}>Mobile Exchange Offers</h3>
                ...
                <div>
                    <h3 style={{textAlign:'left'}}>Mobile Phones</h3>
                ...
                <div>
                    <h3 style={{textAlign:'left'}}>Electronic Devices and Accessories</h3>
