    ...
    return(
        <div>
            <div className="home_footer">
                <div>
                    <h3 className="title" style={{textAlign:'left', fontSize:'16px', fontWeight:'bolder'}}>Flipkart: The One-stop Shopping Destination</h3>
