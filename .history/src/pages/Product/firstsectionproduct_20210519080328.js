                ...
                <div className="row">
                    ...
                    <div className="product-part-one">
                        ...
                        <div className="product-part-one-btn flex space-around">
                            ...
                            <button id="btn1" className="bold" color="blue"><svg class="_2fcmoV" width="14" height="14" viewBox="0 0 16 16" 
                            xmlns="http://www.w3.org/2000/svg"><path class="_2JpNOH"
                             ...
                             </path></svg> ADD TO fCART</button>
                            </Link>
                            <button id="btn2" className="bold" color="blue">BUY NOW</button>
                        </div>
                        </div>
                    </div>
                    ...
                    <div className="col-9 product-part-two">
                        <div className="flex space-btw">
                            <ul style={{listStyleType:'none', fontSize:'10px', wordSpacing:'10px',color:'rgb(135,135,135)'}} className="first-ul">
