                ...
                <div className="row">
                    ...
                    <div className="col-9 product-part-two" style={{marginLeft:'5%'}}>
                        ...
                        <div className="size flex space-btw" style={{display:'flex'}}>
                            <p>Size</p>
                            <ul style={{display:'flex', whiteSpace:'20px'}}>
                                <li><button style={{height:'40px', width:'40px'}}>M</button></li>
                                <li><button style={{height:'40px', width:'40px'}}>L</button></li>
                                <li><button style={{height:'40px', width:'40px'}}>XL</button></li>
                                <li><button style={{height:'40px', width:'40px'}}>XXL</button></li>
