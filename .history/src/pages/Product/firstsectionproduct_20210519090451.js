...
import iconthree from '../../Assets/product/icon-three.png'
import icontwo from '../../Assets/product/icon-two.png'
import star from '../../Assets/product/star.svg'
import ruler from '../../Assets/product/ruler.svg'
import red from '../../Assets/product/red.jpeg'
...
function FirstSectionProduct(props){
    ...
    // console.log(data)
        return(
            <div className="width1200" style={{display:'flex', alignItems:'center',justifyContent:'center',marginTop:'1%', marginLeft:'5%'}}>
                <div className="row">
                    <div className="col-5">
                    <div className="product-part-one">
                        ...
                        <div className="product-part-one-btn flex space-around" style={{margin:'10px'}}>
                    ...
                    <div className="col-9 product-part-two" style={{marginLeft:'5%'}}>
                        <div className="flex space-btw">
                            <ul style={{listStyleType:'none', fontSize:'13px', wordSpacing:'15px',color:'rgb(135,135,135)'}} className="first-ul">
                        ...
                        <div className="check" style={{textAlign:'left'}}>
                            <input type="text" width="100%" placeholder="Enter delivery pincode     Check" />
                        </div>

                        <div className="text" style={{listStyleType:'none', textAlign:'left'}}>
                        ...
                        <div className="size flex space-btw" style={{display:'flex'}}>
                            ...
                            <ul style={{display:'flex',marginLeft:'10%'}}>
                                <li style={{marginLeft:'5px',marginRight:'5px'}}><button style={{height:'40px', width:'40px'}}>M</button></li>
                                <li style={{marginLeft:'5px',marginRight:'5px'}}><button style={{height:'40px', width:'40px'}}>L</button></li>
                                <li style={{marginLeft:'5px',marginRight:'5px'}}><button style={{height:'40px', width:'40px'}}>XL</button></li>
                                <li style={{marginLeft:'5px',marginRight:'5px'}}><button style={{height:'40px', width:'40px'}}>XXL</button></li>
                                <li style={{marginLeft:'5px',marginRight:'5px',marginTop:'5px'}}>Size Chart <img src={ruler} alt="ruler" /></li>
                            </ul>
                            <p></p>
                        </div>
                        ...
                        <div className="rating_review flex space-btw">
                            <div className="r_r" style={{listStyleType:'none'}}>
                                ...
                                <li className="r_rp2"><button className="star">3.5 <img src={star} alt="star" /></button> <span>35 ratings and 5 reviews</span></li>
                            </div>
                            <p><button>Rate Product</button></p>
                        </div>
                        ...
                        <div className="comment_side flex space-btw">
                            ...
                            <div className="likes flex space-btw" style={{listStyleType:'none'}}>
                        ...
                        <div className="post_question flex space-btw">
                            ...
                            <p id="question"><button className="postQuestion">Post Your Question</button></p>
                        </div>
                    </div>
                </div>
            </div>
