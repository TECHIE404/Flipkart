                ...
                <div className="row">
                    ...
                    <div className="col-5">
                        <div className="cart_product_price_background">
                            ...
                            <div className="price_items flex space-btw" style={{display:'flex'}}>
                                <p style={{margin:'30px', textAlign:'left'}}>Price ({getData.length} items)</p>
                                <p style={{color: "green", fontWeight: "bold",margin:'30px', textAlign:'right'}}>₹{total}</p>
                            </div>
                           
                            <div className="delivery_charges flex space-btw" style={{display:'flex'}}>
                                <p style={{margin:'30px', textAlign:'left'}}>Delivery Charges</p>
                                <p style={{color: "green", fontWeight: "bold",margin:'30px', textAlign:'right'}}>FREE</p>
                            </div><hr/>
