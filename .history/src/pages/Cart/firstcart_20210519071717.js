                ...
                <div className="row">
                    <div className="col-7 cart_header_background">
                        <div className="cart_header flex space-btw" style={{display:'flex', margin:'30px'}}>
                            ...
                            <div className="cart_header_links" style={{listStyleType:'none', alignItems:'right', display:'flex'}}>
                                <li><img src={location} /></li>
                                <li>Deliver to</li>
                                <li className="check"><input type="text" placeholder="Enter delivery pincode     Check" />
                                </li>
                            </div>
                        </div><hr/>
