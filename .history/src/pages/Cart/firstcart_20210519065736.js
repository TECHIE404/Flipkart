                ...
                <div className="row">
                    ...
                    <div className="col-5">
                        <div className="cart_product_price_background">
                            ...
                            <div className="price_items flex space-btw" style={{display:'flex', margin:'30px'}}>
                                <p>Price ({getData.length} items)</p>
                                <p style={{textAlign:'right',marginLeft:'60%', color:"bleu", fontWeight:'light'}}>₹{total}</p>
                            </div>
                           
                            <div className="delivery_charges flex space-btw" style={{display:'flex', margin:'30px'}}>
                                <p >Delivery Charges</p>
                                <p style={{color: "green", fontWeight: "bold",marginLeft:'60%', textAlign:'right'}}>FREE</p>
                            </div><hr/>
                            <div className="total_amt flex space-btw" style={{display:'flex', margin:'30px'}}>
                                <p>Total Amount</p>
